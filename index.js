...
`,B=(e,t)=>{let s=[];for(let a=0;a<t;a++)a<e?s.push("done"):a===e?s.push("doing"):s.push("todo");return s},$=(e,t)=>e>0&&e<t-1?{showPreviousBtn:!0,showNextBtn:!0}:e===0?{showPreviousBtn:!1,showNextBtn:!0}:{showPreviousBtn:!0,showNextBtn:!1};function j(e){let t=!0;const{activeComponentClassName:s,inactiveComponentClassName:a}=e;e.showNavigation&&(t=e.showNavigation);let d={};e.prevStyle&&(d=e.prevStyle);let c={};e.nextStyle&&(c=e.nextStyle);const[o,n]=i.useState(B(0,e.steps.length)),[l,r]=i.useState(0),[g,O]=i.useState($(0,e.steps.length)),v=u=>{n(B(u,e.steps.length)),r(u<e.steps.length?u:l),O($(u,e.steps.length))},S=()=>v(l+1),P=()=>v(l>0?l-1:l),A=u=>u.which===13?S(e.steps.length):{},F=u=>{u.currentTarget.value===e.steps.length-1&&l===e.steps.length-1?v(e.steps.length):v(u.currentTarget.value)},L=()=>e.steps.map((u,m)=>i.default.createElement("li",{className:X({state:o[m]}),onClick:F,key:m,value:m},i.default.createElement("span",null,m+1))),T=u=>u&&i.default.createElement("div",null,i.default.createElement("button",{style:g.showPreviousBtn?e.prevStyle:{display:"none"},onClick:P},"Prev"),i.default.createElement("button",{style:g.showNextBtn?e.nextStyle:{display:"none"},onClick:S},"Next"));return i.default.createElement("div",{onKeyDown:A},i.default.createElement(W,null,L()),a?e.steps.map((u,m)=>{const E=m===l?s:a;return i.default.createElement("div",{className:E},u.component)}):i.default.createElement("div",null,e.steps[l].component),i.default.createElement("div",null,T(t)))}
