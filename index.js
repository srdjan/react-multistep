...
`,w=(a,c)=>{let e=[];for(let h=0;h<c;h++)h<a?e.push("done"):h===a?e.push("doing"):e.push("todo");return e},x=(a,c)=>a>0&&a<c-1?{showPreviousBtn:!0,showNextBtn:!0}:a===0?{showPreviousBtn:!1,showNextBtn:!0}:{showPreviousBtn:!0,showNextBtn:!1};function I(a){let c=!0;a.showNavigation&&a.showNavigation&&(c=a.showNavigation);const[e,h]=W.useState(w(0,a.steps.length)),[g,i]=W.useState(0),[d,b]=W.useState(x(0,a.steps.length)),f=j=>{h(w(j,a.steps.length)),i(j<a.steps.length?j:g),b(x(j,a.steps.length))},l=()=>f(g+1),M=()=>f(g>0?g-1:g),N=j=>j.which===13?l(a.steps.length):{},O=j=>{j.currentTarget.value===a.steps.length-1&&g===a.steps.length-1?f(a.steps.length):f(j.currentTarget.value)},P=()=>a.steps.map((j,q)=>W.default.createElement("li",{className:H({state:e[q]}),onClick:O,key:q,value:q},W.default.createElement("span",null,q+1))),Q=j=>j&&W.default.createElement("div",null,W.default.createElement("button",{style:d.showPreviousBtn?{}:{display:"none"},onClick:M},"Prev"),W.default.createElement("button",{style:d.showNextBtn?{}:{display:"none"},onClick:l},"Next"));return W.default.createElement("div",{onKeyDown:N},W.default.createElement(G,null,P()),W.default.createElement("div",null,a.steps[g].component),W.default.createElement("div",null,Q(c)))}
