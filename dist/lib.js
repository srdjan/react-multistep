...
function MultiStep(props) {
  var _useState = (0, _react.useState)(getNavStyles(0, props.steps.length)),
  ...
  var _useState5 = (0, _react.useState)(getButtonsState(0, props.steps.length)),
  ...
  var renderSteps = function renderSteps() {
    return props.steps.map(function(s, i) {
      return _react.default.createElement(
        ...
        _react.default.createElement("em", null, i + 1),
        _react.default.createElement("span", null, props.steps[i].name)
      );
    });
  };
